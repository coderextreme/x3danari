...
class InteractiveAnariRenderer:
    ...
    def _setup_common_geometry(self, vertices, indices, color=None):
        ...
        # Set a single, constant color for the whole object
        material.setParameter('color', anari.FLOAT32_VEC3, color if color is not None else (0.8, 0.8, 0.8))
    ...
    def _setup_hanim_skinned(self, humanoid_node):
        ...
        # DEBUGGING STEP: Force all geometry to be RED. Ignore all textures and materials.
        print("DEBUG: Forcing a constant red material color.")
        forced_color = (1.0, 0.0, 0.0)
        ...
        self._setup_common_geometry(all_vertices, all_indices, color=forced_color)
